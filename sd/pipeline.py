...
def generate(prompt: str,
    ...
    with torch.no_grad():
        ...
        if input_image:
            ...
            latents = sampler(latents, sampler.timesteps[0])
        ...
        for i, timestep in enumerate(timesteps):
            def get_time_embedding(timestep):
                # Define the implementation of the get_time_embedding function here
                pass
        ...
        images = rescale(images, (-1,2), (0,255), clamp=True)
